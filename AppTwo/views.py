...
def register(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_vaid() and profile_form.is_valid():
    ...
    return render(request, 'AppTwo/registrations.html', {'user_from':user_form, 'profile_form':profile_form, 'registered':registered})
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        password = request.POST.gte('password')
